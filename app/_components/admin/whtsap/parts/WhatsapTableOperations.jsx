...
function WhatsapTableOperations() {
  const { filter, setFilter, sort, setSort } = useWhatsapContext();
  return (
    <TableOperations>
      <Filter
        filterField="status"
      ...
      {/* <Modal>
        ...
        <Modal.Window name="Whatsap-form">
          <CreateWhatsapForm resourceName="Whatsap" />
        </Modal.Window>
      </Modal> */}
    </TableOperations>
  );
...
export default WhatsapTableOperations;
