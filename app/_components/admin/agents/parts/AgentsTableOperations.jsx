...
import CreateAgentForm from "@/app/_components/features/Agents/CreateAgentForm";

function AgentsTableOperations() {
  const { filter, setFilter, sort, setSort } = useAgentsContext();
  return (
    <TableOperations>
      <Filter
        filterField="status"
      ...
      <Modal>
        ...
        <Modal.Window name="agent-form">
          <CreateAgentForm resourceName="Agent" />
        </Modal.Window>
      </Modal>
    </TableOperations>
  );
...
export default AgentsTableOperations;
