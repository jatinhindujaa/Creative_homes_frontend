...
function ListpropertyTableOperations() {
  const { filter, setFilter, sort, setSort } = useListpropertyContext();
  return (
    <TableOperations>
      <Filter
        filterField="status"
      ...
      />
      {/* <Modal>
        <Modal.Open opens="Listproperty-form">
        ...
        <Modal.Window name="Listproperty-form">
          <CreateListpropertyForm resourceName="Listproperty" />
        </Modal.Window>
      </Modal> */}
    </TableOperations>
  );
...
export default ListpropertyTableOperations;
