...
import {
  useDeleteMultiImageFromOffplan,
  useUpdateMultiImagesFromOffplan,
} from "../../admin/offplan/useOffplan";
import FileInput from "../../ui/FileInput";

const ImagesFormOffplan = ({
  id,
  onConfirm,
  disabled,
  editData,
  ...
  const { mutate: removeMultiImageFromOffplan } =
    useDeleteMultiImageFromOffplan();
  const { mutate: updateMultiImagesFromOffplan, isPending: isAddingImages } =
    useUpdateMultiImagesFromOffplan();
  ...
  const handleDeleteImage = (index) => {
    removeMultiImageFromOffplan({ id, formData: { index } });
...
export default ImagesFormOffplan;
