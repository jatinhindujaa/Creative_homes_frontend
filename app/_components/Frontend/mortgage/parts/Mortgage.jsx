  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <div className="lg:w-[80%] w-[90%] bg-[#202120] flex flex-col items-center my-10 rounded-xl">
        <div className="text-white p-6 rounded-lg w-full mt-7 shadow-lg flex flex-col md:flex-row">
        ...
        <div className="flex lg:justify-start justify-center items-center w-full p-[1.5rem]">
          <button className="bg-white px-6 py-2 rounded-[30px] mr-4 text-[1.2rem]">
            Calculate
          </button>
          <button
