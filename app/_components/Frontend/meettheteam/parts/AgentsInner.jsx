        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="mt-8 md:mt-0 flex gap-4">
            <a
              ...
              rel="noopener noreferrer"
            >
              <button className="w-full flex-1 border text-white border-white px-4 py-2 rounded-full hover:bg-white hover:text-black transition text-md flex gap-2 items-center">
                <FaWhatsapp size={20} /> WhatsApp
              </button>
            </a>
            <a href={`tel:${agents?.phoneNo}`}>
              <button className="w-[100%] flex-1 border text-white border-white px-4 py-2 rounded-full hover:bg-white hover:text-black transition text-md flex gap-2 items-center">
