export default function ExploreDubai() {
  return (
    <section className="rounded-2xl shadow-2xl p-6 md:p-10 mx-auto md:max-w-6xl mt-28 md:mt-28 max-w-[22rem]">
      <h2 className="text-3xl md:text-4xl font-semibold text-white mb-4">
        Meet Our team
      </h2>
      <p className="text-white text-lg leading-relaxed">
        Our property specialists cover Dubai’s key communities, offering a range
