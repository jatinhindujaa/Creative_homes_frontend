...
const Privacypolicy = () => {
  ...
  return (
      ...
      <div className="min-h-screen bg-[#282927] text-white py-10 w-[80%]">
        <div className="mx-auto pt-16 text-white">
          <h1 className="text-3xl font-semibold mb-6">Privacy Policy</h1>

          <p className="mb-4">
            At <strong>Creative Homes</strong>, we are committed to protecting
            ...
            provide us through our website. Please read this policy carefully to
          ...
          <p className="mb-4">
            ...
            trusted property advisors who assist us in delivering our services
            to you. They are obligated to keep your information confidential and
            are not allowed to use it for any other purpose.
          </p>
          ...
          <p className="mb-4">
            ...
            collection, use, and disclosure of your personal data as described
