export default function ExploreDubai() {
  return (
    <section className="rounded-2xl shadow-2xl p-6 md:p-10 mx-auto md:max-w-7xl mt-16 md:mt-28 max-w-[19rem]">
      <h2 className="text-3xl md:text-4xl font-normal text-white mb-4">
        Why Invest In Dubai?
      </h2>
      <p className="text-white text-lg leading-relaxed">
        Dubai offers a highly rewarding real estate market—if approached wisely.
