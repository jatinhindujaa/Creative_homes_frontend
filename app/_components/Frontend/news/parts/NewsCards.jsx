...
//       {data.map((d) => (
//         <div className="flex flex-row  p-6 md:p-10 items-center gap-6">
//           {/* Image Section */}
//           <div className="w-full md:w-1/3 relative">
//             <Image
//               src={d.img} // Replace with actual image path
//               alt="Award winners"
...
//             {/* Read More and Views Section */}
//             <div className="flex items-center gap-4">
//               <button className="bg-black text-white px-4 py-2 rounded-3xl flex items-center gap-2 border border-none hover:bg-gray-800">
//                 Read More{" "}
//                 <span className="text-2xl bg-white text-black rounded-2xl w-8 ">
//                   +
//                 </span>
//               </button>
//             </div>
