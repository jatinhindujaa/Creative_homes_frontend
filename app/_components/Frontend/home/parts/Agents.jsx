...
const Agents = () => {
  ...
  return (
    <div className="flex flex-col md:gap-[50px] gap-[10px]">
      ...
      {/* Tabs */}
      <div className="w-[80%] mx-auto flex-wrap rounded-[40px] justify-between p-3 relative bg-gradient-to-r from-[rgba(255,255,255,0.3)_0.07%] to-[rgba(255,255,255,0.2)_97%] lg:flex hidden max-w-[1200px]">
        {Object.keys(groupedAgents).map((type) => (
          <button
            key={type}
            className={`relative z-10 px-6 py-2 text-[1.4rem] rounded-[30px] transition-all duration-500 ${
