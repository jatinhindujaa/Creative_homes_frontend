  ...
  return (
    <div className="relative h-screen flex flex-col items-center justify-center bg-black">
      ...
      <div className="relative z-10 flex w-3/5 flex-col items-center justify-center text-white text-center px-4 gap-4">
        <h1 className="text-[5.5rem] font-normal uppercase">contact US</h1>
        ...
        <div className="bg-white bg-opacity-20 backdrop-blur-lg py-5 rounded-full px-10 gap-4 flex">
          <Button
            text="General Enquiry"
            className="w-fit text-[1.2rem] text-black bg-white leading-[2.4rem] px-5 py-1 font-normal tracking-wider"
          />
          <HoverButton
            text="Find  A Consultant"
            className="w-fit text-[1.2rem] leading-[2.4rem] px-5 py-1 font-normal tracking-wider"
          />
        </div>
      </div>
