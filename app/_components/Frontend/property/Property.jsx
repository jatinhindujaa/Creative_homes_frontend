...
let title = "Property";
let description =
  "Our property specialists cover Dubai’s key communities, offering a range of services including Residential & Commercial Sales and Leasing, Off-Plan Investments, Property Management, and more.";

// Set title and description based on offeringtype
if (offeringtypeFilter === "buy") {
  title = "Properties for Sale in Dubai";
  description = ` Explore an exclusive selection of residential and commercial properties available for sale across Dubai's most desirable communities. Creative Homes empowers you with expert guidance, comprehensive market insights, and a seamless buying experience, whether you're seeking a luxury villa, a modern apartment, or a strategic investment opportunity`;
} else if (offeringtypeFilter === "rent") {
  title = "Properties for Rent in Dubai";
  description = `Maps Dubai's dynamic rental market with ease. Creative Homes offers a diverse portfolio of apartments, villas, and commercial spaces for rent in prime locations like Dubai Marina, Downtown Dubai, and Business Bay. Our specialists ensure a smooth and efficient process to help you secure the perfect rental property that fits your lifestyle and budget.`;
} else if (offeringtypeFilter === "sale") {
  title = "Properties for Sale in Dubai";
  description = `Explore an exclusive selection of residential and commercial properties available for sale across Dubai's most desirable communities. Creative Homes empowers you with expert guidance, comprehensive market insights, and a seamless buying experience, whether you're seeking a luxury villa, a modern apartment, or a strategic investment opportunity.`;
}
  return (
